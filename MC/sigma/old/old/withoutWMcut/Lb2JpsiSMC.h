...
// Thu Jul 23 19:28:07 2015 by ROOT version 5.34/10
// from TTree mytree/mytree
// found on file: /afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiSMC.root
//////////////////////////////////////////////////////////
...
#ifdef Lb2JpsiSMC_cxx
Lb2JpsiSMC::Lb2JpsiSMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiSMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiSMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiSMC.root:/Lb2JpsiLTree");
...
Lb2JpsiSMC::~Lb2JpsiSMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Lb2JpsiSMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Lb2JpsiSMC::LoadTree(Long64_t entry)
{
...
void Lb2JpsiSMC::Init(TTree *tree)
{
...
void Lb2JpsiSMC::Show(Long64_t entry)
{
...
Int_t Lb2JpsiSMC::Cut(Long64_t entry)
{
