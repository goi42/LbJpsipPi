...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   massJpsipPi->Draw();
   canvas1->Print("massJpsipPiSMC.pdf");
   ...
   cutmassJpsipPi->Draw();
   canvas4->Print("cutmassJpsipPiSMC.pdf");
   ...
   massJpsiL->Draw();
   canvas5->Print("massJpsiLSMC.pdf");
   ...
   cutmassJpsiL->Draw();
   canvas6->Print("cutmassJpsiLSMC.pdf");
