...
myApplication.optsfile = [File('DataXb2JpsiS.py')]
j = Job(name='Lb2JSData', application=myApplication, backend=Dirac())
...
j.inputdata = j.application.readInputData('../test/sampleDST/LHCb_Collision11_Beam3500GeVVeloClosedMagDown_Real_Data_Reco14_Stripping20r1_90000000_DIMUON.DST.py')
