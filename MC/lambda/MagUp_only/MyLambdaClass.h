...
// Wed Nov  4 22:44:00 2015 by ROOT version 6.04/02
// from TTree mytree/mytree
// found on file: /afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/withKScut/Lb2JpsiLMC.root
//////////////////////////////////////////////////////////

#ifndef MyLambdaClass_h
#define MyLambdaClass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MyLambdaClass(TTree *tree=0);
   virtual ~MyLambdaClass();
...
#ifdef MyLambdaClass_cxx
MyLambdaClass::MyLambdaClass(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/withKScut/Lb2JpsiLMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/withKScut/Lb2JpsiLMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/withKScut/Lb2JpsiLMC.root:/Lb2JpsiLTree");
...
MyLambdaClass::~MyLambdaClass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MyLambdaClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MyLambdaClass::LoadTree(Long64_t entry)
{
...
void MyLambdaClass::Init(TTree *tree)
{
...
void MyLambdaClass::Show(Long64_t entry)
{
...
Int_t MyLambdaClass::Cut(Long64_t entry)
{
