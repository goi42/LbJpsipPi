...
myApplication.optsfile = [File('runmc.py')]
j = Job(name='test', application=myApplication, backend=Dirac())
...
j.outputfiles = [DiracFile('mc.root')] #has to match what's in optsfile
