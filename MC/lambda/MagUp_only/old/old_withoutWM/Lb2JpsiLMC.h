...
// Tue Jul 21 20:55:05 2015 by ROOT version 5.34/10
// from TTree mytree/mytree
// found on file: /afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiLMC.root
//////////////////////////////////////////////////////////
...
#ifdef Lb2JpsiLMC_cxx
Lb2JpsiLMC::Lb2JpsiLMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiLMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiLMC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/Lb2JpsiLMC.root:/Lb2JpsiLTree");
...
Lb2JpsiLMC::~Lb2JpsiLMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Lb2JpsiLMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Lb2JpsiLMC::LoadTree(Long64_t entry)
{
...
void Lb2JpsiLMC::Init(TTree *tree)
{
...
void Lb2JpsiLMC::Show(Long64_t entry)
{
...
Int_t Lb2JpsiLMC::Cut(Long64_t entry)
{
