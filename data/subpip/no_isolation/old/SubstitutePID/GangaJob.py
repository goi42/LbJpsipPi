...
myApplication = DaVinci(version = 'v36r1') #good version
...
j = Job(name='subLb2JpLData', application=myApplication, backend=Dirac())
...
j.outputfiles = [DiracFile('subDVNtuples.root')] #has to match what's in optsfile
