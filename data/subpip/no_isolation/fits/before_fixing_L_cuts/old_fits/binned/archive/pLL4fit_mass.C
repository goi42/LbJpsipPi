...
void fit_mass() {
  TString fileN = "LL4";//suffix added before file extension, e.g., '.pdf'
  ...
  // Construct Pdf Model
  // /\0
  RooRealVar mean1L("mean1L","/\\ gaus 1: mean",5621.103,5525,5700);
  RooRealVar sig1L("sig1L","/\\ gaus 1: sigma",6.899,0,100);
  RooFormulaVar mean2L("mean2L","@0",RooArgList(mean1L));
  // RooRealVar mean2L("mean2L","/\\ gaus 2: mean",5621.302,5525,5700);
  RooRealVar sig2L("sig2L","/\\ gaus 2: sigma",14.694,0,100);
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst1("meanLst1","/\\*: mean1",5012.987,4500,5250);
  RooRealVar sigLst1("sigLst1","/\\*: sigma1",70.155,0,1000);
  RooRealVar meanLst2("mean5Lst2","/\\*: mean2",5247.918,5000,5350);
  RooRealVar sigLst2("sigLst2","/\\*: sigma2",60.139,0,1000);
  RooRealVar alphaLst2("alphaLst2","/\\*: alpha2",18.526,0,1000);
  ...
  RooRealVar b1("b1","Background: Chebychev b1",-1.181,-10000,10000);
  RooRealVar b2("b2","Background: Chebychev b2",0.479,-10000,10000);
  ...
  RooArgList bList(b1,b2,b3,b4,b5,b6);
