...
//=============================================================================
void makeplots(TString runmode = "d", TString drawopt = ""){
  ...
  //default parameters
  cout<<"setting default parameters..."<<endl;
  TString outputlocation="./";
  TString filename="plots.pdf";
  int nFiles=1;
  vector<TFile*> f(nFiles);
  TString tuplelocation = "/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/data/";
  placeholder = tuplelocation+"subLimDVNtuples.root";
  f[0] = TFile::Open(placeholder);
  vector<TString> tree(nFiles);
  tree[0] = "Lb2JpsiLTree/mytree";
  int nLayers=2;// branch, cuts
  vector<TString> Lresponse(nLayers);
  Lresponse[0]="branch";
  Lresponse[1]="cut";
  vector<int> nL(nLayers);
  nL[0]=164;
  nL[1]=1;//just with cuts(including K_S)
  ...
  L[1][0]="";
  int bL=0;//index corresponding to branch layer
  int nBranches=164;
  if(nBranches!=nL[bL]){
    cout<<"nBranches="<<nBranches<<endl<<"nL["<<bL<<"]="<<nL[bL]<<endl;
    exit(EXIT_FAILURE);
  }
  int cL=1;//index corresponding to cut layer
  int nCuts=1;
  if(nCuts!=nL[cL]){
    cout<<"nCuts="<<nCuts<<endl<<"nL["<<cL<<"]="<<nL[cL]<<endl;
    exit(EXIT_FAILURE);
  }
  ...
  cut.resize(nFiles);
  cout<<"filling branches and cuts..."<<endl;
  cout<<"nFiles = "<<nFiles<<endl;
  for(int i=0;i<nFiles;i++){//resize and fill branch and cut vectors; there's only 1 file
    cout<<"on file "<<i<<endl;
    cut[i].resize(nBranches);
    branch[i].push_back("BsL0Global_TIS");
    branch[i].push_back("BsHlt1Global_TIS");
    branch[i].push_back("BsHlt1Phys_TIS");
    branch[i].push_back("BsHlt2Global_TIS");
    branch[i].push_back("BsHlt2Phys_TIS");
    branch[i].push_back("BsStrippingGlobal_TIS");
    branch[i].push_back("BsL0DiMuonDecision_TIS");
    branch[i].push_back("BsL0HCALDecision_TIS");
    branch[i].push_back("BsL0MuonDecision_TIS");
    branch[i].push_back("BsL0MuonHighDecision_TIS");
    branch[i].push_back("BsHlt1SingleMuonNoIPL0Decision_TIS");
    branch[i].push_back("BsHlt1DiMuonHighMassDecision_TIS");
    branch[i].push_back("BsHlt1DiMuonLowMassDecision_TIS");
    branch[i].push_back("BsHlt1SingleMuonHighPTDecision_TIS");
    branch[i].push_back("BsHlt1SingleMuonNoIPDecision_TIS");
    branch[i].push_back("BsHlt1TrackAllL0Decision_TIS");
    branch[i].push_back("BsHlt1TrackMuonDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonBDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonDY1Decision_TIS");
    branch[i].push_back("BsHlt2DiMuonDetachedDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonDetachedHeavyDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonDetachedJPsiDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonJPsiDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonJPsiHighPTDecision_TIS");
    branch[i].push_back("BsHlt2ExpressJPsiDecision_TIS");
    branch[i].push_back("BsHlt2ExpressJPsiTagProbeDecision_TIS");
    branch[i].push_back("BsHlt2SingleMuonDecision_TIS");
    branch[i].push_back("BsHlt2SingleMuonHighPTDecision_TIS");
    branch[i].push_back("BsHlt2SingleMuonLowPTDecision_TIS");
    branch[i].push_back("BsHlt2Topo2BodyBBDTDecision_TIS");
    branch[i].push_back("BsHlt2Topo2BodySimpleDecision_TIS");
    branch[i].push_back("BsHlt2Topo3BodyBBDTDecision_TIS");
    branch[i].push_back("BsHlt2Topo3BodySimpleDecision_TIS");
    branch[i].push_back("BsHlt2Topo4BodyBBDTDecision_TIS");
    branch[i].push_back("BsHlt2Topo4BodySimpleDecision_TIS");
    branch[i].push_back("BsHlt2TopoMu2BodyBBDTDecision_TIS");
    branch[i].push_back("BsHlt2TopoMu3BodyBBDTDecision_TIS");
    branch[i].push_back("BsHlt2TopoMu4BodyBBDTDecision_TIS");
    branch[i].push_back("BsHlt2TransparentDecision_TIS");
    branch[i].push_back("BsHlt2DiMuonUnbiasedJPsiDecision_TIS");
    branch[i].push_back("J_psi_1SL0Global_TIS");
    branch[i].push_back("J_psi_1SHlt1Global_TIS");
    branch[i].push_back("J_psi_1SHlt1Phys_TIS");
    branch[i].push_back("J_psi_1SHlt2Global_TIS");
    branch[i].push_back("J_psi_1SHlt2Phys_TIS");
    branch[i].push_back("J_psi_1SStrippingGlobal_TIS");
    branch[i].push_back("J_psi_1SL0DiMuonDecision_TIS");
    branch[i].push_back("J_psi_1SL0HCALDecision_TIS");
    branch[i].push_back("J_psi_1SL0MuonDecision_TIS");
    branch[i].push_back("J_psi_1SL0MuonHighDecision_TIS");
    branch[i].push_back("J_psi_1SHlt1SingleMuonNoIPL0Decision_TIS");
    branch[i].push_back("J_psi_1SHlt1DiMuonHighMassDecision_TIS");
    branch[i].push_back("J_psi_1SHlt1DiMuonLowMassDecision_TIS");
    branch[i].push_back("J_psi_1SHlt1SingleMuonHighPTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt1SingleMuonNoIPDecision_TIS");
    branch[i].push_back("J_psi_1SHlt1TrackAllL0Decision_TIS");
    branch[i].push_back("J_psi_1SHlt1TrackMuonDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonBDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDY1Decision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDetachedDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDetachedHeavyDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDetachedJPsiDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonJPsiDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonJPsiHighPTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2ExpressJPsiDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2ExpressJPsiTagProbeDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2SingleMuonDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2SingleMuonHighPTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2SingleMuonLowPTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2Topo2BodyBBDTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2Topo2BodySimpleDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2Topo3BodyBBDTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2Topo3BodySimpleDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2Topo4BodyBBDTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2Topo4BodySimpleDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2TopoMu2BodyBBDTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2TopoMu3BodyBBDTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2TopoMu4BodyBBDTDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2TransparentDecision_TIS");
    branch[i].push_back("J_psi_1SHlt2DiMuonUnbiasedJPsiDecision_TIS");
    branch[i].push_back("BsL0Global_TOS");
    branch[i].push_back("BsHlt1Global_TOS");
    branch[i].push_back("BsHlt1Phys_TOS");
    branch[i].push_back("BsHlt2Global_TOS");
    branch[i].push_back("BsHlt2Phys_TOS");
    branch[i].push_back("BsStrippingGlobal_TOS");
    branch[i].push_back("BsL0DiMuonDecision_TOS");
    branch[i].push_back("BsL0HCALDecision_TOS");
    branch[i].push_back("BsL0MuonDecision_TOS");
    branch[i].push_back("BsL0MuonHighDecision_TOS");
    branch[i].push_back("BsHlt1SingleMuonNoIPL0Decision_TOS");
    branch[i].push_back("BsHlt1DiMuonHighMassDecision_TOS");
    branch[i].push_back("BsHlt1DiMuonLowMassDecision_TOS");
    branch[i].push_back("BsHlt1SingleMuonHighPTDecision_TOS");
    branch[i].push_back("BsHlt1SingleMuonNoIPDecision_TOS");
    branch[i].push_back("BsHlt1TrackAllL0Decision_TOS");
    branch[i].push_back("BsHlt1TrackMuonDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonBDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonDY1Decision_TOS");
    branch[i].push_back("BsHlt2DiMuonDetachedDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonDetachedHeavyDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonDetachedJPsiDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonJPsiDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonJPsiHighPTDecision_TOS");
    branch[i].push_back("BsHlt2ExpressJPsiDecision_TOS");
    branch[i].push_back("BsHlt2ExpressJPsiTagProbeDecision_TOS");
    branch[i].push_back("BsHlt2SingleMuonDecision_TOS");
    branch[i].push_back("BsHlt2SingleMuonHighPTDecision_TOS");
    branch[i].push_back("BsHlt2SingleMuonLowPTDecision_TOS");
    branch[i].push_back("BsHlt2Topo2BodyBBDTDecision_TOS");
    branch[i].push_back("BsHlt2Topo2BodySimpleDecision_TOS");
    branch[i].push_back("BsHlt2Topo3BodyBBDTDecision_TOS");
    branch[i].push_back("BsHlt2Topo3BodySimpleDecision_TOS");
    branch[i].push_back("BsHlt2Topo4BodyBBDTDecision_TOS");
    branch[i].push_back("BsHlt2Topo4BodySimpleDecision_TOS");
    branch[i].push_back("BsHlt2TopoMu2BodyBBDTDecision_TOS");
    branch[i].push_back("BsHlt2TopoMu3BodyBBDTDecision_TOS");
    branch[i].push_back("BsHlt2TopoMu4BodyBBDTDecision_TOS");
    branch[i].push_back("BsHlt2TransparentDecision_TOS");
    branch[i].push_back("BsHlt2DiMuonUnbiasedJPsiDecision_TOS");
    branch[i].push_back("J_psi_1SL0Global_TOS");
    branch[i].push_back("J_psi_1SHlt1Global_TOS");
    branch[i].push_back("J_psi_1SHlt1Phys_TOS");
    branch[i].push_back("J_psi_1SHlt2Global_TOS");
    branch[i].push_back("J_psi_1SHlt2Phys_TOS");
    branch[i].push_back("J_psi_1SStrippingGlobal_TOS");
    branch[i].push_back("J_psi_1SL0DiMuonDecision_TOS");
    branch[i].push_back("J_psi_1SL0HCALDecision_TOS");
    branch[i].push_back("J_psi_1SL0MuonDecision_TOS");
    branch[i].push_back("J_psi_1SL0MuonHighDecision_TOS");
    branch[i].push_back("J_psi_1SHlt1SingleMuonNoIPL0Decision_TOS");
    branch[i].push_back("J_psi_1SHlt1DiMuonHighMassDecision_TOS");
    branch[i].push_back("J_psi_1SHlt1DiMuonLowMassDecision_TOS");
    branch[i].push_back("J_psi_1SHlt1SingleMuonHighPTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt1SingleMuonNoIPDecision_TOS");
    branch[i].push_back("J_psi_1SHlt1TrackAllL0Decision_TOS");
    branch[i].push_back("J_psi_1SHlt1TrackMuonDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonBDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDY1Decision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDetachedDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDetachedHeavyDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonDetachedJPsiDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonJPsiDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonJPsiHighPTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2ExpressJPsiDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2ExpressJPsiTagProbeDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2SingleMuonDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2SingleMuonHighPTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2SingleMuonLowPTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2Topo2BodyBBDTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2Topo2BodySimpleDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2Topo3BodyBBDTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2Topo3BodySimpleDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2Topo4BodyBBDTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2Topo4BodySimpleDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2TopoMu2BodyBBDTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2TopoMu3BodyBBDTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2TopoMu4BodyBBDTDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2TransparentDecision_TOS");
    branch[i].push_back("J_psi_1SHlt2DiMuonUnbiasedJPsiDecision_TOS");
    
    if(branch[i].size()!=(unsigned int)nBranches){
      cout<<"branch["<<i<<"].size()="<<branch[i].size()<<endl;
      cout<<"nBranches="<<nBranches<<endl;
      exit(EXIT_FAILURE);
    }
    cout<<"nBranches = "<<nBranches<<endl;
    for(int j=0; j<nBranches; j++){
      cout<<"we're on branch "<<j<<endl;
      ...
      for(int k=0; k<nCuts; k++){//there's only one cut (no cut)
        cout<<"we're on cut "<<k<<endl;
        // if(k==0){
        //cut[i][j][k]="";
        // } else if(k==1){
        placeholder="(((H1_TRACK_Type==3)&&(H2_TRACK_Type==3)&&(H1_TRACK_GhostProb<0.2)&&(H2_TRACK_GhostProb<0.2)";
        placeholder+="&&(Bs_DIRA_OWNPV>0.9999)&&(R_FDCHI2_ORIVX>50)&&(R_MM>1112)&&(R_MM<1120)&&(R_PT>1000))||";
        placeholder+="((R_PT>1000)&&(R_ENDVERTEX_Z>500)&&(H1_TRACK_Type==5)&&(H2_TRACK_Type==5)&&(Bs_DIRA_OWNPV>0.9999)";
        placeholder+="&&(R_FDCHI2_ORIVX>50)&&(R_MM>1110)&&(R_MM<1122)&&(Bs_ENDVERTEX_CHI2/Bs_ENDVERTEX_NDOF<10)&&";
        placeholder+="((J_psi_1S_MM-3096.92)>-48)&&((J_psi_1S_MM-3096.92)<43)))";
        placeholder+="&&(((R_WM-497.614)<-40)||((R_WM-497.614)>40))";
        cout<<placeholder<<endl;
        cut[i][j][k] = placeholder;
        // }
  ...
  int nhpc=1;
  int nCanvases=1;
  for(int i=0;i<nLayers;i++){//calculate nhpc and nCanvases based on comparisons and layers
    if(i>=(nLayers-nComparisons)){ nhpc*=nL[i];
    }else{nCanvases *= nL[i];}
  }
  ...
  for(int ci=0; ci<nCanvases; ci++){
    ...
    for(int hi=0; hi<nhpc; hi++){
      ...
      cout<<"setting line color..."<<endl;
      h[ci][hi]->SetLineColor(hi+1);
      cout<<"setting branch name and porting to histogram"<<endl;
      placeholder = branch[file_num][Li[bL]]+">>"+hname;
      cout<<"drawing branch with specified cut"<<endl;
      MyTree->Draw(placeholder,cut[file_num][Li[bL]][Li[cL]],drawopt);
      cout<<"iterating the number of plots drawn"<<endl;
