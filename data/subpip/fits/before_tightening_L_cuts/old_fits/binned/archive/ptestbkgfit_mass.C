...
void fit_mass() {
  TString fileN = "testbkg";//suffix added before, e.g., '.pdf'
  ...
  //Poly func BKG mass
  RooRealVar b1("b1","Background: Chebychev b1",-0.9513,-1000,-0.0000001);
  RooRealVar b2("b2","Background: Chebychev b2",-0.9513,-1000,-0.0000001);
  RooRealVar b3("b3","Background: Chebychev b3",-0.9513,-1000,-0.0000001);
  ...
  //fit the totalPdf
  RooAbsReal * nll = totalPdf.createNLL(*data,Extended(kTRUE),Range(4300,4800));//cut off edges
  RooMinuit m(*nll);
  m.setVerbose(kFALSE);
