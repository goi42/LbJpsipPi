...
void fit_mass() {
  TString fileN = "LL5_fixalpha";//suffix added before file extension, e.g., '.pdf'
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst1("meanLst1","/\\*(misc.): mean1",5012.986855,4900,5100);
  RooRealVar sigLst1("sigLst1","/\\*(misc.): sigma1",70.153539,0,100);
  RooRealVar meanLst2("mean5Lst2","/\\*(1405): mean2",5247.917931,5100,5350);
  RooRealVar sigLst2("sigLst2","/\\*(1405): sigma2",60.150575,0,100);
  RooRealVar alphaLst2("alphaLst2","/\\*(1405): alpha2",16.679742);
  RooRealVar nLst2("nLst2","/\\*(1405): n2",3.995681,0,50);
  ...
  RooRealVar b1("b1","Background: Chebychev b1",-1.070623,-10,-0);
  RooRealVar b2("b2","Background: Chebychev b2",0.316567,0,10);
