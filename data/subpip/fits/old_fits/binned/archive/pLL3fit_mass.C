...
void fit_mass() {
  TString fileN = "LL3";//suffix added before file extension, e.g., '.pdf'
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst1("meanLst1","/\\*: mean1",5011.936,4500,5250);
  RooRealVar sigLst1("sigLst1","/\\*: sigma1",74.337,0,1000);
  RooRealVar meanLst2("mean5Lst2","/\\*: mean2",5248.879,5000,5350);
  RooRealVar sigLst2("sigLst2","/\\*: sigma2",61.729,0,1000);
  RooRealVar alphaLst2("alphaLst2","/\\*: alpha2",9.868,0,1000);
  ...
  RooRealVar fLst1("fLst1","/\\* bkg: fraction gaus 1",0.741,0,1);
  RooAddPdf bkgLst("bkgLst","#Lambda* signal",RooArgList(gauLst1,CBLst2),RooArgList(fLst1));
  
  //Poly func BKG mass
  RooRealVar b1("b1","Background: Chebychev b1",-1.114,-10000,10000);
  RooRealVar b2("b2","Background: Chebychev b2",0.368,-10000,10000);
