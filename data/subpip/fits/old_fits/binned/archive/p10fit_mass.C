...
void fit_mass() {
  TString fileN = "10";//suffix added before file extension, e.g., '.pdf'
  ...
  // Construct Pdf Model
  // /\0
  RooRealVar mean1L("mean1L","/\\0 gaus 1: mean",5621.333,5525,5700);
  RooRealVar sig1L("sig1L","/\\0 gaus 1: sigma",8.092,0,100);
  RooFormulaVar mean2L("mean2L","@0",RooArgList(mean1L));
  // RooRealVar mean2L("mean2L","/\\0 gaus 2: mean",5621.302,5525,5700);
  RooRealVar sig2L("sig2L","/\\0 gaus 2: sigma",21.145,0,100);
  ...
  RooRealVar f1L("f1L","/\\0 signal: fraction gaus 1",0.515,0,1);
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst1("meanLst1","/\\*: mean1",5018.077,4500,5250);
  RooRealVar sigLst1("sigLst1","/\\*: sigma1",68.689,0,1000);
  RooRealVar meanLst2("mean5Lst2","/\\*: mean2",5249.279,5000,5350);
  RooRealVar sigLst2("sigLst2","/\\*: sigma2",76.446,0,1000);
  RooRealVar alphaLst2("alphaLst2","/\\*: alpha2",2.208,0,1000);
  RooRealVar nLst2("nLst2","/\\*: n2",0,0,1000);
  ...
  //Poly func BKG mass
  RooRealVar b0("b0","Background: Chebychev b0",-1.153,-10000,10000);
  RooRealVar b1("b1","Background: Chebychev b1",0.321,-10000,10000);
  RooRealVar b2("b2","Background: Chebychev b2",0.001,-10000,10000);
  RooRealVar b3("b3","Background: Chebychev b3",0.047,-10000,10000);
