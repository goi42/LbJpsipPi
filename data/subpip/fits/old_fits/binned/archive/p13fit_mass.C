...
void fit_mass() {
  TString fileN = "13";//suffix added before file extension, e.g., '.pdf'
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst1("meanLst1","/\\*: mean1",5005.280,4500,5250);
  RooRealVar sigLst1("sigLst1","/\\*: sigma1",57.254,0,1000);
  RooRealVar meanLst2("mean5Lst2","/\\*: mean2",5286.318,5000,5350);
  RooRealVar sigLst2("sigLst2","/\\*: sigma2",44.658,0,1000);
  RooRealVar alphaLst2("alphaLst2","/\\*: alpha2",0,0,1000);
  RooRealVar nLst2("nLst2","/\\*: n2",30.465,0,1000);
  ...
  RooRealVar fLst1("fLst1","/\\* bkg: fraction gaus 1",0.166,0,1);
  ...
  RooRealVar b1("b1","Background: Chebychev b1",-0.926,-10000,10000);
  RooRealVar b2("b2","Background: Chebychev b2",0.370,-10000,10000);
