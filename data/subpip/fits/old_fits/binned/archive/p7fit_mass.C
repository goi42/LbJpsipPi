...
void fit_mass() {
  TString fileN = "7";//suffix added before file extension, e.g., '.pdf'
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst("mean5Lst","/\\*: mean",5030.308,4800,5150);
  RooRealVar sigLst("sig5Lst","/\\*: sigma",99.984,0,100);
  RooGaussian bkgLst("bkgLst","#Lambda* bkg",*mass,meanLst,sigLst);
  
  //Poly func BKG mass
  RooRealVar b0("b0","Background: Chebychev b0",-68.275185,-10000,-0.00000001);
  RooRealVar b1("b1","Background: Chebychev b1",-0.950,-10000,-0.00000001);
