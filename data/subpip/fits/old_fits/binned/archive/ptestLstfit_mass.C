...
void fit_mass() {
  TString fileN = "testLst";//suffix added before file extension, e.g., '.pdf'
  ...
  RooRealVar sigLst("sig5Lst","/\\*: sigma",68.195365,sigmin,sigmax);
  RooGaussian bkgLst("bkgLst","#Lambda* bkg",*mass,meanLst,sigLst);
  
  //Poly func BKG mass
  RooRealVar b1("b1","Background: Chebychev b1",-125.842925,-144.991725,-106.694125);
  RooRealVar b2("b2","Background: Chebychev b2",-68.275185,-82.665805,-53.884565);
  RooRealVar b3("b3","Background: Chebychev b3",-39.678173,-79.118833,-0.237513);
  ...
  //fit the totalPdf
  RooAbsReal * nll = totalPdf.createNLL(*data,Extended(kTRUE),Range(4300,5250));//cut off edges
  RooMinuit m(*nll);
  m.setVerbose(kFALSE);
