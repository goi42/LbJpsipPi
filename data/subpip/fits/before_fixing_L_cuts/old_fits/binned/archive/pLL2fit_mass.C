...
void fit_mass() {
  TString fileN = "LL2";//suffix added before file extension, e.g., '.pdf'
  ...
  // /\*
  cout<<"Lst stuff"<<endl;
  RooRealVar meanLst1("meanLst1","/\\*: mean1",5050,4500,5250);
  RooRealVar sigLst1("sigLst1","/\\*: sigma1",8.209,0,1000);
  RooRealVar meanLst2("mean5Lst2","/\\*: mean2",5286.348,5000,5350);
  RooRealVar sigLst2("sigLst2","/\\*: sigma2",44.652,0,1000);
  RooRealVar alphaLst2("alphaLst2","/\\*: alpha2",0,0,1000);
  RooRealVar nLst2("nLst2","/\\*: n2",0.075,0,1000);
  ...
  //Poly func BKG mass
  RooRealVar b0("b0","Background: Chebychev b0",-0.926,-10000,10000);
  RooRealVar b1("b1","Background: Chebychev b1",0.371,-10000,10000);
  RooRealVar b2("b2","Background: Chebychev b2",-0.316,-10000,10000);
