...
void fit_mass(TString fileN="test") {//suffix added before file extension, e.g., '.pdf'
  ...
  TString tracktype = "DD"; //"LL","DD",""
  if(!(tracktype=="LL"||tracktype=="DD"||tracktype=="")) {
    cout<<"What track type? line 38."<<endl;
    exit(EXIT_FAILURE);
  }
  ...
  RooDataSet data_temp = get_data_LM(mass,tracktype);
  RooDataSet *data = &data_temp;
  cout<<"fit_mass: Mass and data set."<<endl;

  cout<<"fit_mass: Assign shapes:"<<endl;
  // // sigma
  // TFile *SMChistos= new TFile("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/withKScut/histos_SMCfile_new.root", "READ");
  ...
  // // /\*(1405)
  // //roohistpdf
  // TFile *Lst1405MChistos= new TFile("/afs/cern.ch/work/m/mwilkins/Lb2JpsiLtr/MC/withKScut/histos_Lst1405MC_new.root", "READ");
