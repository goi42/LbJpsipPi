...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      if(((H1_TRACK_Type==3)&&(H2_TRACK_Type==3)&&(H1_TRACK_GhostProb<0.2)&&(H2_TRACK_GhostProb<0.2)&&(Bs_DIRA_OWNPV>0.9999) \
        ...
        if((dwmassR<-40)||(dwmassR>40)){
          ...
          if((Bs_LOKI_MASS_JpsiConstr>=5470)&&(Bs_LOKI_MASS_JpsiConstr<=5770))cutmassLb7yield++;
          if((H1_TRACK_Type==3)&&(H2_TRACK_Type==3)){
            cutmassLb8->Fill(Bs_LOKI_MASS_JpsiConstr);
            if((Bs_LOKI_MASS_JpsiConstr>=5470)&&(Bs_LOKI_MASS_JpsiConstr<=5770))cutmassLb8yield++;
          }
          if((H1_TRACK_Type==5)&&(H2_TRACK_Type==5)){
            cutmassLb9->Fill(Bs_LOKI_MASS_JpsiConstr);
            if((Bs_LOKI_MASS_JpsiConstr>=5470)&&(Bs_LOKI_MASS_JpsiConstr<=5770))cutmassLb9yield++;
          }
        }
        //pID cut:
   ...
   chi2ndf->Draw();
   canvas1->Print("plots/plots.pdf(");
   TCanvas *canvas2 = new TCanvas("canvas2","GhostProb",1200,800);
   canvas2->Divide(2,2);
   cout<<"canvas 2/17 made"<<endl;
   canvas2->cd(1);
   gStyle->SetOptStat(kFALSE);
   ...
   cutmassLb4->Draw();
   canvas8->Print("plots/plots.pdf(");
   TCanvas *canvas9 = new TCanvas("canvas9","cutmassLb5",1200,800);
   cout<<"canvas 9/17 made"<<endl;
   gStyle->SetOptStat("e");
   ...
   cutmassLb6->Draw();
   canvas10->Print("plots/plots.pdf(");
   TCanvas *canvas11 = new TCanvas("canvas11","cutmassLb7",1200,800);
   cout<<"canvas 11/17 made"<<endl;
   gStyle->SetOptStat("e");
   ...
   cutmassLb7->Draw();
   canvas11->Print("plots/plots.pdf(");
   TCanvas *canvas12 = new TCanvas("canvas12","cutmassLb8",1200,800);
   cout<<"canvas 12/17 made"<<endl;
   gStyle->SetOptStat("e");
   ...
   cutmassLb8->Draw();
   canvas12->Print("plots/plots.pdf(");
   TCanvas *canvas13 = new TCanvas("canvas13","cutmassLb9",1200,800);
   cout<<"canvas 13/17 made"<<endl;
   gStyle->SetOptStat("e");
   ...
   cout<<"Liming's and KS: "<<cutmassLb7yield<<endl;
   cout<<"ditto LL: "<<cutmassLb8yield<<endl<<"ditto DD: "<<cutmassLb9yield<<endl;
   cout<<"Liming's, KS, and pID: "<<cutmassLb10yield<<endl;
   cout<<"ditto LL: "<<cutmassLb11yield<<endl<<"ditto DD: "<<cutmassLb12yield<<endl;
   cout<<"done"<<endl;
}
