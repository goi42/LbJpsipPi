...
// Mon Aug  3 22:09:10 2015 by ROOT version 5.34/32
...
#ifdef countstuff_cxx
countstuff::countstuff(TTree *tree) : fChain(0) 
{
...
Int_t countstuff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t countstuff::LoadTree(Long64_t entry)
{
...
void countstuff::Init(TTree *tree)
{
...
void countstuff::Show(Long64_t entry)
{
...
Int_t countstuff::Cut(Long64_t entry)
{
