...
TString placeholder;
TString Lbname[]={"B0"};//,"Bs","Bs"};//,"Bs"};//,"Bs"};//make sure to have 1 per file
TString massname[]={"B0_LOKI_MASS_JpsiConstr"};//,"Bs_LOKI_MASS_JpsiConstr","Bs_LOKI_MASS_JpsiConstr"};//,"Bs_LOKI_MASS_JpsiConstr"};
...
void makecuts(int ifile,TCut &cLL,TCut &cDD,TCut &ctrigger,TCut &cB02JpsiKst) {//,TCut &cB02JpsiKst_mass){
  ...
  TCut cut4("cut4","B0_DIRA_OWNPV>0.99993&&B0_ENDVERTEX_CHI2/B0_ENDVERTEX_NDOF<5&&B0_IPCHI2_OWNPV<25");
